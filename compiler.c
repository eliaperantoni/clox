...
// namedVariable adds the provided identifier token to the chunk constants array and emits an OP to either assign to or
...
// variable is the same as namedVariable expect it uses the previous, just-consumed token, as the variable name
